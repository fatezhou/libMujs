...
static void print(js_State *jss){
	const char* pstr = js_tostring(jss, 1);
	printf("%s\n", pstr);
	js_pushundefined(jss);
}

void load_(js_State *J, const char* pFileName){
	FILE* fp;
